...
class CeilingFan:
    ...
    def medium(self):
        ...
        print()
        self._location + " ceiling fan is on medium"

    def low(self):
        "turns the ceiling fan on to low"
        self._speed = self.LOW
        print()
        self._location + " ceiling fan is on low"

    def off(self):
        "turns the ceiling fan off"
        self._speed = self.OFF
        print()
        self._location + " ceiling fan is off"
...
class Hottub:
    ...
    def set_temperature(self, temperature):
        if temperature > self._temperature:
            print()
            "Hottub is heating to a steaming " + str(temperature) + " degrees"
        else:
            print()
            "Hottub is cooling to " + str(temperature) + " degrees"
...
class Light:
    ...
    def dim(self, level):
        ...
        if self._level == 0:
            ...
            print()
            "Light is dimmed to " + self._level + "%"
...
class Stereo:
    ...
    def on(self):
        print()
        self._location + " stereo is on"

    def off(self):
        print()
        self._location + " stereo is off"

    def set_cd(self):
        print()
        self._location + " stereo is set for CD input"

    def set_dvd(self):
        print()
        self._location + " stereo is set for DVD input"

    def set_radio(self):
        print()
        self._location + " stereo is set for Radio"

    def set_volume(self, volume):
        """ code to set the volume
        valid range: 1-11 (after all 11 is better than 10, right?)"""
        print()
        self._location + " Stereo volume set to " + volume
...
class TV:
    ...
    def on(self):
        print()
        self._location + " TV is on"

    def off(self):
        print()
        self._location + " TV is off"

    def set_input_channel(self):
        self._channel = 3
        print()
        self._location + " TV channel is set for DVD"
