...
"""
BEFORE USING/TESTING THIS DELETE UNDO() FROM INTERFACE AND FROM ALL REALIZATIONS.
"""
...
class Stereo:
    ...
    def set_volume(self, volume):
        ...
        """
        print()
        self._location + " Stereo volume set to " + str(volume)
...
class CeilingFanHighCommang(Command):
